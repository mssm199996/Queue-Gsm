...
public class SQLiteDialect extends Dialect {
    ...
    public String getDropForeignKeyString() {
        throw new UnsupportedOperationException("No drop foreign key syntax supported by Tools.SQLiteDialect");
    }
    ...
    public String getAddForeignKeyConstraintString(String constraintName,
        ...
        throw new UnsupportedOperationException("No add foreign key syntax supported by Tools.SQLiteDialect");
    }

    @Override
    public String getAddPrimaryKeyConstraintString(String constraintName) {
        throw new UnsupportedOperationException("No add primary key syntax supported by Tools.SQLiteDialect");
    }
